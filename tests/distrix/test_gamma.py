...
from stamox.distrix import pgamma, rgamma, qgamma, dgamma
...
class GammaTest(jtest.JaxTestCase):
    ...
    def test_pgamma(self):
        ...
        true_p = np.array(
            [0.01752310, 0.06155194, 0.12190138, 0.19120786, 0.26424112])
    ...
    def test_dgamma(self):
        ...
        true_grads = np.array(
            [0.3274923, 0.5362560, 0.6585740, 0.7189263, 0.7357589])
