...
def step_fun(x, y, ival=0.0, sorted=False, side="left"):
    ...
    Returns:
        Array: evaluates the step function at given points.
    """
...
def ecdf(x, side="right"):
    ...
    Returns:
        Array: The empirical cumulative distribution function of the given array.
    """
